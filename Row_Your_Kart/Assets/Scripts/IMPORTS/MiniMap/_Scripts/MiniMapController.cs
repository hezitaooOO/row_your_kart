...
//Initialize everything here
	...
	void SetCam(){
		...
		if (target == null) {
			...
			//mapCamera.transform.position = target.position + cameraOffset + new Vector3(0, 100, 0);
			mapCamera.transform.position = new Vector3(309.54f, 21.03f, 65.45f) + cameraOffset + new Vector3(-55, 100, 193);
		}
	}
